        ...
        <div className="container mx-auto px-6">
          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="relative overflow-hidden rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 bg-black group"
            >
              <div className="aspect-video w-full relative">
                <iframe
                  src="https://drive.google.com/file/d/1dlLxzAwvFTDoECREnG_yEOLG1jmL0v62/preview"
                  className="absolute inset-0 w-full h-full border-0"
                  allow="autoplay; fullscreen"
                  title="Ganga Farms Video Tour"
                ></iframe>
              </div>
            </motion.div>
